...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Iniciando Launcher...", "author": "IgnExotic" },
            { "message": "Conectando con los servidores...", "author": "IgnExotic" },
            { "message": "Servidores en Linea.", "author": "IgnExotic" }
        ];
    ...
    async checkUpdate() {
        ...
        ipcRenderer.invoke('update-app').then().catch(err => {
            return this.shutdown(`Error al buscar una actualizacion :<br>${err.message}`);
        });
    ...
    async maintenanceCheck() {
        config.GetConfig().then(res => {
            ...
            console.error(e);
            return this.shutdown("No tiene conexion a internet!,<br>conectese e intentelo de nuevo.");
        })
    }
